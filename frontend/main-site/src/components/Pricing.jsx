...
export default function Pricing() {
  ...
  return (
    <div className="w-full h-full flex flex-col justify-center py-20 relative">
        ...
        <div className="mt-8 flex items-center justify-center">
          <div className="bg-slate-200 p-1 rounded-full flex relative shadow-inner">
            <button
              ...
              className={`relative z-10 px-8 py-3 text-sm font-bold rounded-full transition-colors ${
                activeTab === 'buyer' ? 'text-slate-900' : 'text-slate-500 hover:text-slate-700'
              }`}
            >
            ...
            <div
              className={`absolute top-1 bottom-1 w-[50%] bg-white rounded-full shadow-md transition-all duration-300 ease-out ${
                activeTab === 'buyer' ? 'left-1' : 'left-[calc(50%-4px)]'
              }`}
            />
          </div>
        </div>
